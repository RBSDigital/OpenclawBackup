...
- Pattern-Key: [REDACTED_SECRET] | harden.input_validation (optional, for recurring-pattern tracking)
...
3. Search `.learnings/LEARNINGS.md` for an existing entry with that key:
   [REDACTED_SECRET] `grep -n "Pattern-Key: [REDACTED_SECRET]" .learnings/LEARNINGS.md`
4. If found:
