...
**Auth:** All requests require `x-api-key: [REDACTED_SECRET]
...
```bash
export COMPOSIO_API_KEY="[REDACTED_SECRET]"
...
| `queries[].known_fields` | No | Comma-separated key:[REDACTED_SECRET] pairs of known inputs (e.g., `"channel_name: general, timezone: UTC"`) |
